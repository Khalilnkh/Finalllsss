...
namespace EduMap.Migrations
{
    ...
    [Migration("20221216140313_CreatedRelWithCourseAndBlog")]
    partial class CreatedRelWithCourseAndBlog
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduMap.Models.Blog", b =>
                {
                    ...
                    b.HasIndex("CourseHomeId");

                    b.ToTable("Blogs");
                });

            modelBuilder.Entity("EduMap.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EduMap.Models.CourseFeatures", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EduMap.Models.CourseTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EduMap.Models.Tags", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EduMap.Models.TeacherSkill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EduMap.Models.Blog", b =>
                {
                    b.HasOne("EduMap.Models.CourseHome", "CourseHome")
                        .WithMany("Blogs")
                        .HasForeignKey("CourseHomeId")
            ...
            modelBuilder.Entity("EduMap.Models.CourseHome", b =>
                {
                    b.HasOne("EduMap.Models.Category", "Category")
                        .WithMany("CourseHomes")
            ...
            modelBuilder.Entity("EduMap.Models.CourseTag", b =>
                {
                    ...
                    b.HasOne("EduMap.Models.Tags", "Tags")
                        .WithMany("CourseTags")
